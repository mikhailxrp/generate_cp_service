...
import { addPreset } from "@/app/actions/addPreset";
import { showToast } from "@/lib/toast";

export default function AddPresetModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await addPreset(formData);
      if (result.success) {
        ...
        showToast.error("Ошибка при добавлении пресета: " + result.error);
      }
    } catch (error) {
      showToast.error("Ошибка при добавлении пресета: " + error.message);
    } finally {
