...
export default function CpBlockGround() {
  return (
    <div className="cp-block cp-block-six">
      ...
      <div className="cp-block-six-title">
        <h2 className="cp-block-six-title__h2">
          <span className="cp-block-six-title__green">НАЗЕМНАЯ </span>
          <span className="cp-block-six-title__black">ОПОРНАЯ КОНСТРУКЦИЯ</span>
        </h2>
      </div>
      ...
      <div className="cp-block-six-wrapper mt-5">
        <div className="cp-block-six-inner-left">
          <p className="cp-block-five-subtitle mb-4">
            Надёжное решение для размещения солнечных электростанций на грунте.
          </p>
          <div className="cp-block-six-inner-bullet">
            <div className="cp-block-six-bullet-item">
              ...
              <div className="cp-block-six-bullet-item__content">
                ...
                <p className="cp-block-six-bullet-item__text">
                  Монтаж наземных опорных конструкций выполняется на свайные
                  основания различных типов
                </p>
              </div>
            </div>
            ...
            <div className="cp-block-six-bullet-item">
              ...
              <div className="cp-block-six-bullet-item__content">
                ...
                <p className="cp-block-six-bullet-item__text">
                  Технология позволяет в короткие сроки развернуть станцию и
                  быстро ввести её в эксплуатацию
                </p>
              </div>
            </div>
            ...
            <div className="cp-block-six-bullet-item">
              ...
              <div className="cp-block-six-bullet-item__content">
                ...
                <p className="cp-block-six-bullet-item__text">
                  Горячее цинкование металла обеспечивает защиту от коррозии на
                  30+ лет в любых грунтах
                </p>
              </div>
            </div>
            ...
            <div className="cp-block-six-bullet-item">
              ...
              <div className="cp-block-six-bullet-item__content">
                ...
                <p className="cp-block-six-bullet-item__text">
                  Возможность задать оптимальный угол наклона и азимут для
