...
export default function CpBlockLeasing({ clientName }) {
  return (
    <div className="cp-block cp-block-six">
      <div className="cp-line-header">
        <div className="cp-line-header__pill">
          <span className="cp-line-header__pill-text">ФИНАНСИРОВАНИЕ</span>
        </div>
      ...
      <div className="cp-block-leasing-wrapper mt-5"></div>
      <div className="cp-block-leasing-footer">{clientName}</div>
    </div>
  );
}
