...
// ============================================================================
// МАППИНГ ДЛЯ СМАРТМЕТРОВ (идентично importSmartmeters.js)
// ============================================================================
...
async function importSmartmetersFromCsv() {
  try {
    const csvPath = resolve(process.cwd(), "./data/PRICE_SMARTMETER.csv");

    await importFromCsv({
      csvPath,
      categoryCode: "smartmeter",
      categoryName: "Смартметры",
      mapRowToPriceItem: mapSmartmeterRowToPriceItem,
      db,
