...
// ============================================================================
// МАППИНГ ДЛЯ ВЫКЛЮЧАТЕЛЕЙ (идентично importPowOff.js)
// ============================================================================
...
async function importPowOffFromCsv() {
  try {
    const csvPath = resolve(process.cwd(), "./data/PRICE_POW_OFF.csv");

    await importFromCsv({
      csvPath,
      categoryCode: "pow_off",
      categoryName: "Выключатели нагрузки",
      mapRowToPriceItem: mapPowOffRowToPriceItem,
      db,
