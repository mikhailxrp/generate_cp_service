...
/**
 * "Пуленепробиваемый" парсер для колонки "Цена_базовая", который умеет:
 * - числа (1000, 0.2)
 * - проценты ("20%", "20 %" и даже "20% от суммы")
 * - берёт первое число из строки и, если там есть %, превращает его в долю (20% → 0.2)
 * @param {any} v - значение из CSV
 * @returns {number|null}
 */
